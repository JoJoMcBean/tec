...
class CasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post cases_url, params: { case: { category: @case.category, client_id: @case.client_id, description: @case.description, lawyer_id: @case.lawyer_id } }
    end
  ...
  test "should update case" do
    patch case_url(@case), params: { case: { category: @case.category, client_id: @case.client_id, description: @case.description, lawyer_id: @case.lawyer_id } }
